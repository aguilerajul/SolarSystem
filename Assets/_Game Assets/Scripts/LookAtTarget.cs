...
public class LookAtTarget : MonoBehaviour {
    ...
    [SerializeField]
    TMPro.TextMeshProUGUI planetGameObject;

    void Awake()
    {
        if (planetGameObject != null && string.IsNullOrWhiteSpace(planetGameObject.text)) {
            planetGameObject.text = string.Empty;
        }
    }
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            if (hits.Length>0)
            {
                ...
                planetGameObject.text = currentTarget.name;
